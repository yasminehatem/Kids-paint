...
{	
	...
	if(UI.InterfaceMode == MODE_DRAW)	//GUI in the DRAW mode
	{
		...
		{	
			...
			case ITM_CHNGBK_CLR: return CHNG_BK_CLR;
			case ITM_CHNGDRW_CLR: return CHNG_DRAW_CLR;
			case ITM_CHNGFILL_CLR: return CHNG_FILL_CLR;
			case ITM_CHNGBORDERWDTH: return CHNG_BORDER_WDTH;
			case ITM_SELECT: return SELECT;
			case ITM_RESIZE: return RESIZE;
			case ITM_ZOOM: return ZOOM;
			case ITM_ROTATE: return ROTATE;
			case ITM_BACK_FRONT_SWAP: return BACK_FRONT_SWAP;
